...
<html lang="es">
<head>
    @include('pdf.partials.multi-sector-single-bird-head')
</head>
<body>
...
<section class="report-initial-situation-page">
    ...
    <div class="report-initial-situation-page__content">
        ...
        <p class="report-initial-situation-page__species">Especies identificadas: Paloma doméstica (Columba livia).</p>
        ...
        <table class="report-initial-situation-page__table">
            ...
            <tbody>
                <tr>
                    <td>Paloma doméstica (<em>Columba livia</em>)</td>
                    <td>{{ $cantidad_primera_visita_historica }}</td>
                </tr>
            </tbody>
        </table>
    </div>
...
<section class="report-service-details-page" aria-label="Detalles del servicio por lugar de control">
    ...
    @if ($detalleServicioPorUbicacionSecciones === [])
        <p class="report-service-details-page__empty">Sin sectores configurados para este cliente.</p>
    @else
        @foreach ($detalleServicioPorUbicacionSecciones as $section)
